...
<div class="tab-pane show active" id="pills-user" role="tabpanel" aria-labelledby="pills-user-tab">
    ...
    <div>
        <div class="user-profile-img">
            <img src="{{asset('images/small/img-4.jpg')}}" class="profile-img" style="height: 160px;" alt="">
        ...
        <div class="text-center p-3 p-lg-4 border-bottom pt-2 pt-lg-2 mt-n5 position-relative">
            <div class="mb-lg-3 mb-2">
                <img src="{{auth()->user()->avatar ?? asset('images/users/user-dummy-img.jpg')}}"
                     class="rounded-circle avatar-lg img-thumbnail"
                     alt="">
            </div>

            <h5 class="font-size-16 mb-1 text-truncate">{{auth()->user()->username}}</h5>
            <p class="text-muted font-size-14 text-truncate mb-0">{{auth()->user()->email}}</p>
        </div>
        <!-- End profile user -->
