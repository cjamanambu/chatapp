...
const profileImg =
    user.value.profile_img || "https://via.placeholder.com/500x500";
    ...
    >
        ...
        <div>
            <div class="user-profile-img">
                <img
                    :src="profileImg"
                    class="profile-img profile-foreground-img"
                    style="height: 160px"
                    alt="profile-img"
                />
            ...
            <div
                class="text-center p-3 p-lg-4 border-bottom pt-2 pt-lg-2 mt-n5 position-relative"
            >
                ...
                <div class="dropdown d-inline-block">
                    <a
                        class="text-muted dropdown-toggle d-block"
                        href="#"
                        role="button"
                    ...
                    >
                        <i
                            class="bx bxs-circle text-success font-size-10 align-middle"
                        ></i>
                        Active <i class="mdi mdi-chevron-down"></i>
                    </a>

                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="#"
                            ><i
                                class="bx bxs-circle text-success font-size-10 me-1 align-middle"
                            ></i>
                            Active</a
                        >
                        <a class="dropdown-item" href="#"
                            ><i
                                class="bx bxs-circle text-warning font-size-10 me-1 align-middle"
                            ></i>
                            Away</a
                        >
                        <a class="dropdown-item" href="#"
                            ><i
                                class="bx bxs-circle text-danger font-size-10 me-1 align-middle"
                            ></i>
                            Do not disturb</a
                        >
                    </div>
                ...
                <div id="settingprofile" class="accordion accordion-flush">
                    <div class="accordion-item">
                        <div class="accordion-header" id="headerpersonalinfo">
                            <button
                                class="accordion-button font-size-14 fw-medium"
                                type="button"
                            ...
                            >
                                <i class="bx bxs-user text-muted me-3"></i>
                                Personal Info
                            </button>
                        </div>
                        <div
                        ...
                        >
                            <div class="accordion-body">
                                <div class="float-end">
                                    ...
                                    >
                                        <i
                                            class="bx bxs-pencil align-middle"
                                        ></i>
                                    </button>
                                </div>
                    ...
                    <div class="accordion-item">
                        <div class="accordion-header" id="privacy1">
                            <button
                                class="accordion-button font-size-14 fw-medium collapsed"
                                type="button"
                                data-bs-toggle="collapse"
                            ...
                            >
                                <i class="bx bxs-lock text-muted me-3"></i
                                >Privacy
                            </button>
                        </div>
                        <div
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item py-3 px-0 pt-0">
                                        <div class="d-flex align-items-center">
                                            ...
                                            >
                                                <h5
                                                    class="font-size-13 mb-0 text-truncate"
                                                >
                                                    Profile photo
                                                </h5>
                                            </div>
                    ...
                    <div class="accordion-item">
                        <div class="accordion-header" id="headersecurity">
                            ...
                            >
                                <i
                                    class="bx bxs-check-shield text-muted me-3"
                                ></i>
                                Security
                            </button>
                        </div>
                    ...
                    <div class="accordion-item">
                        <div class="accordion-header" id="headerhelp">
                            ...
                            >
                                <i
                                    class="bx bxs-help-circle text-muted me-3"
                                ></i>
                                Help
                            </button>
                        </div>
