    ...
    >
        ...
        <div>
            ...
            <div class="chat-room-list" data-simplebar>
                ...
                <h5
                    class="mb-3 px-4 mt-4 font-size-11 text-muted text-uppercase"
                >
                    Favourites
                </h5>
                ...
                <div class="chat-message-list">
                    <ul
                        class="list-unstyled chat-list chat-user-list mb-3"
                        id="channelList"
                    ></ul>
                </div>
        ...
        <div
            ...
            tabindex="-1"
            role="dialog"
            aria-labelledby="create-groupLabel"
            aria-hidden="true"
        >
            <div
            ...
            >
                ...
                >
                    <div class="modal-header">
                        <h5
                            class="modal-title text-white font-size-16"
                            id="create-groupLabel"
                        >
                            Create Channel
                        </h5>
                        <button
